...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(235754488689254400L);
        System.out.println("response = " + response);
    }
    ...
    @Test
    void updateTest() {
        ArticleResponse response = update(235748944528371712L);
        System.out.println("response = " + response);
    }
