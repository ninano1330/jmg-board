package jmg.board.article.service;

import jmg.board.article.entity.Article;
import jmg.board.article.entity.BoardArticleCount;
import jmg.board.article.repository.ArticleRepository;
import jmg.board.article.repository.BoardArticleCountRepository;
...
public class ArticleService {
    ...
    public List<ArticleResponse> readAllInfiniteScroll(Long boardId, Long pageSize, Long lastArticleId) {
        ...
        return articles.stream().map(ArticleResponse::from).toList(); // TODO
    }
